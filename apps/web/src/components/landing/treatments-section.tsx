...
const POPULAR_TREATMENTS: TreatmentItem[] = [
  {
    ...
    description:
      "Para suavizar líneas de expresión y lograr un rostro más descansado y natural.",
  },
  {
    id: "ultherapy-prime",
    ...
    description:
      "Para tensar y reposicionar la piel sin cirugía, estimulando el colágeno desde adentro.",
  },
  {
    id: "luz-pulsada",
    name: "Luz pulsada",
    ...
    icon: "wb_sunny",
    short: "Para unificar el tono, reducir manchas, rojeces y mejorar la textura general de la piel.",
    description:
      "Para unificar el tono, reducir manchas, rojeces y mejorar la textura general de la piel.",
  },
  {
    ...
    description:
      "Para estimular la renovación celular y recuperar vitalidad, luminosidad y calidad de la piel.",
  },
  {
    ...
    description:
      "Para restaurar volúmenes perdidos y armonizar los rasgos de forma sutil y personalizada.",
  },
  {
    id: "otros",
    name: "Otros",
...
const MORE_TREATMENTS: TreatmentItem[] = [
  ...
  },
  {
    ...
    icon: "water_drop",
    short:
      "Para limpiar, exfoliar y nutrir la piel en una sola sesión, con tecnología Alquimia. Resultado inmediato y sin tiempo de recuperación.",
    description:
      "Para limpiar, exfoliar y nutrir la piel en una sola sesión, con tecnología Alquimia. Resultado inmediato y sin tiempo de recuperación.",
  },
  {
    ...
    category: "Facial",
    icon: "layers",
    short: "Para renovar la piel, mejorar manchas, textura y luminosidad.",
    description: "Para renovar la piel, mejorar manchas, textura y luminosidad.",
  },
  {
    id: "control-de-acne",
    ...
    category: "Clínica",
    icon: "healing",
    short: "Para tratar brotes activos y las marcas que dejan, con protocolo médico.",
    description: "Para tratar brotes activos y las marcas que dejan, con protocolo médico.",
  },
  {
    id: "rejuvenecimiento",
    ...
    category: "Estética",
    icon: "auto_awesome",
    short: "Para recuperar una expresión más fresca y descansada combinando distintos enfoques.",
    description: "Para recuperar una expresión más fresca y descansada combinando distintos enfoques.",
  },
  {
    ...
    icon: "vaccines",
    short: "Para estimular desde adentro la calidad del cabello y la piel del cuerpo.",
    description: "Para estimular desde adentro la calidad del cabello y la piel del cuerpo.",
  },
  {
    id: "mesoglow-plus",
    name: "Mesoglow PLUS",
    category: "Facial",
    icon: "flare",
    short: "Para hidratar, iluminar y renovar el rostro en una sola sesión combinada.",
    description: "Para hidratar, iluminar y renovar el rostro en una sola sesión combinada.",
  },
  {
    id: "exosomas-facial",
    ...
    category: "Facial",
    icon: "science",
    short: "Para regenerar y reparar la piel a nivel celular, con tecnología de última generación.",
    description:
      "Para regenerar y reparar la piel a nivel celular, con tecnología de última generación.",
  },
  {
    id: "exosomas-capilar",
