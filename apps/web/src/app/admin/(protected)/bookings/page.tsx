...
export default function AdminBookingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-headline text-3xl text-slate-900">Reservas y solicitudes</h1>
      ...
      <div className="flex flex-wrap gap-2 rounded-xl bg-white p-2 shadow-sm ring-1 ring-slate-200/80">
        {TABS.map((t) => (
          <button
            key={t.id}
            type="button"
